  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        serimar: {
          dark: "hsl(var(--serimar-dark))",
          teal: "hsl(var(--serimar-teal))",
          "teal-dark": "hsl(var(--serimar-teal-dark))",
          "light-green": "hsl(var(--serimar-light-green))",
        },
        semaforo: {
          ...
          gris: "hsl(var(--semaforo-gris))",
          "gris-bg": "hsl(var(--semaforo-gris-bg))",
        },
        sidebar: {
